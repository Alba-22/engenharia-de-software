...
# Importa de forma programática todos os arquivos python (.py) encontrados no diretório das entidades
# para permitir a auto geração de migrations pelo alembic.
# O diretório de entidade é referenciado por caminho relativo, portanto caso esse arquivo ou o diretório
# relevante sejam movidos de lugar, o bloco pode deixar de funcionar.
...
def run_migrations_online():
    ...
    custom_config["sqlalchemy.url"] = Settings().DB_URL
